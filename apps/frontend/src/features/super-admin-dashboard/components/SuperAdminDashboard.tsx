      ...
      <div className="rounded-2xl border border-border/80 bg-card px-wilms-5 py-wilms-5 sm:px-wilms-6">
        <div className="flex flex-col gap-wilms-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <p className="text-small font-medium tracking-wide text-text-muted">
              {timeGreeting}, {user?.displayName ?? 'Admin'}
            </p>
            <h1 className="mt-wilms-1 text-heading-1 font-semibold text-text-primary">
              Operations Overview
            </h1>
            <p className="mt-wilms-1 text-[13px] leading-relaxed text-text-muted/90">
          ...
          <div className="flex w-full max-w-md flex-col gap-2 sm:ml-auto sm:w-auto sm:min-w-[16rem]">
            <button
              ...
              className="group inline-flex h-11 w-full min-h-[44px] items-center justify-between gap-3 rounded-full border border-border bg-background px-4 text-small text-text-muted transition-colors hover:border-brand-primary/40 hover:text-text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary"
            >
              <span className="flex min-w-0 items-center gap-2.5">
                <Search
                  className="h-4 w-4 shrink-0 text-brand-primary motion-safe:transition-transform motion-safe:duration-300 motion-safe:group-hover:scale-110"
                  aria-hidden="true"
                />
                <span className="truncate">Search borrowers, loans, groups…</span>
              </span>
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand-primary text-white motion-safe:transition-transform motion-safe:duration-300 motion-safe:group-hover:translate-x-0.5">
                <ArrowRight
                  className="h-3.5 w-3.5 motion-safe:animate-[wilms-nudge_2.4s_ease-in-out_infinite]"
                  aria-hidden="true"
                />
              </span>
            </button>
            <Link
              ...
              className="group inline-flex h-11 w-full min-h-[44px] items-center justify-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-5 text-small font-semibold text-amber-800 transition-colors hover:border-amber-500/45 hover:bg-amber-500/15 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500/50 dark:text-amber-200 sm:w-auto"
            >
              <Ruler
                className="h-4 w-4 motion-safe:transition-transform motion-safe:duration-300 motion-safe:group-hover:rotate-6 motion-safe:animate-[wilms-soft-pulse_2.8s_ease-in-out_infinite]"
                aria-hidden="true"
              />
              Loan rules
            </Link>
