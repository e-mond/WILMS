...
export const ROUTE_PERMISSION_REQUIREMENTS: { prefix: string; permissions: PermissionId[] }[] = [
  ...
  { prefix: '/documentation', permissions: [PERMISSION.ACCESS_ADMIN_PORTAL] },
  ...
  { prefix: '/borrower-updates', permissions: [PERMISSION.ACCESS_ADMIN_PORTAL, PERMISSION.ACCESS_REGISTRATION_PORTAL] },
...
export const NAV_ITEM_PERMISSIONS: Record<string, PermissionId[]> = {
  ...
  '/records': [PERMISSION.ACCESS_ADMIN_PORTAL],
  '/borrower-updates': [PERMISSION.ACCESS_ADMIN_PORTAL],
  ...
  '/officer/records': [PERMISSION.ACCESS_REGISTRATION_PORTAL],
  '/approver/records': [PERMISSION.ACCESS_APPROVER_PORTAL],
  '/auditor/records': [PERMISSION.ACCESS_AUDITOR_PORTAL],
  ...
  '/officer/borrower-updates': [PERMISSION.ACCESS_REGISTRATION_PORTAL],
