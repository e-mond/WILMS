...
export const REPORT_CATALOG: ReportCatalogEntry[] = [
  ...
  },
  {
    ...
    category: 'risk',
    description: 'Loans with DEFAULTED status and outstanding arrears.',
    recordCount: 47,
    route: '/reports/defaulters',
  },
  {
    id: 'report-missed-payments',
    title: 'Missed Payments Report',
    generatedAt: '2026-06-08T12:30:00.000Z',
    category: 'risk',
    description: 'Active loans with missed schedule weeks — opens from dashboard alerts.',
    recordCount: 0,
  ...
  {
    id: 'report-aging-analysis',
    title: 'Aging Analysis Report',
    generatedAt: '2026-06-09T09:15:00.000Z',
    category: 'risk',
