...
function rowToRecord(row: typeof borrowers.$inferSelect): BorrowerRecord {
  ...
  return {
    ...
    subDistrictUnitId: row.subDistrictUnitId ?? undefined,
    electoralAreaId: row.electoralAreaId ?? undefined,
...
function recordToInsert(record: BorrowerRecord) {
  return {
    ...
    subDistrictUnitId: record.subDistrictUnitId ?? null,
    electoralAreaId: record.electoralAreaId ?? null,
