...
const REGISTRATION_LEGAL_CONFIG: RegistrationLegalConfig = {
  ...
  instructionText:
    'Please review all sections carefully and ensure that all required information is provided accurately and completely before submitting this form. A recent passport-style photograph is required. If a signature is not provided electronically, it must be completed manually after printing the form.',
  programDeclaration:
    "This form records the applicant's information, declarations and relevant programme information for participation in the Women's Interest-Free Loan Programme. The information provided is subject to review, verification and approval in accordance with the applicable Programme requirements.",
  guarantorDeclaration:
    'I confirm that I have agreed to act as a guarantor for the applicant named in this form.\n\nI declare that the information I have provided is true and accurate to the best of my knowledge. I understand the responsibilities associated with acting as a guarantor under the Women\'s Interest-Free Loan Programme and agree to comply with the applicable Programme requirements.',
  borrowerDeclaration:
    'I declare that the information provided in this application is true, complete and accurate to the best of my knowledge.\n\nI understand that participation in the Women\'s Interest-Free Loan Programme is subject to review, verification and approval. I agree to comply with the Programme\'s applicable membership, group and repayment requirements and acknowledge that false, fraudulent, misleading or materially incomplete information may result in the application being rejected, suspended, disqualified or subject to further action in accordance with the Programme\'s rules and applicable law.',
  keyTerms:
  ...
  legalNotice:
    'This application is submitted for consideration under the Women\'s Interest-Free Loan Programme and does not, by itself, constitute approval or entitlement to a loan.\n\nAll information provided is subject to verification and review. The submission of false, fraudulent or misleading information may result in rejection, suspension, disqualification or other action permitted under the Programme\'s rules and applicable law.\n\nIf the application is approved and funds are subsequently disbursed to the applicant, this completed application, together with any declarations, consents, acknowledgements and electronically recorded information provided by the applicant, shall form part of the applicant\'s official programme and loan record and may be relied upon in administering, enforcing or resolving matters arising from the loan, subject to applicable law.\n\nFollowing approval and disbursement, the applicant acknowledges that no separate loan application or duplicate execution of the information contained in this form shall ordinarily be required, except where additional documentation is required by law, the Programme\'s procedures, or for a specific transaction or purpose.\n\nBy submitting this application, the applicant confirms that the information provided is true, accurate and complete and acknowledges the terms and conditions applicable to participation in the Programme.\n\nThis document shall be retained as part of the applicant\'s official Programme and loan record.',
