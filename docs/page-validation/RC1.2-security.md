...
Extends [`RC1.1-rbac-matrix.md`](RC1.1-rbac-matrix.md) — collector self-access, admin-only routes, officer blocks.
...
| Risk | Control | Gap |
|------|---------|-----|
| Authn | HMAC session + login schema | — |
| Authz | RBAC middleware + smoke matrix | — |
...
| CSRF | `wilms_csrf` cookie + header | — |
| Uploads | Type/size limits, Cloudinary | — |
