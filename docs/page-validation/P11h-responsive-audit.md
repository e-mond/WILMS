...
|-------|--------|-----------------|------------|--------------|--------|
| 320px | Simplified bar + overflow | Fixed FAB | Operational roles: 3–5 col grid | Full width, `pb-24` when bottom nav | Pass (code) |
...
- `src/tests/layouts/shells.test.tsx` — role shells render with mobile drawer + chrome.
- `src/tests/reports/ReportsIndexPanel.responsive.test.tsx` — report layout.
- `src/tests/components/MultiStepForm.test.tsx` — step progression UI.
