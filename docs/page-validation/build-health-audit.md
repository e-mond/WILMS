...
| Group | Routes | Status |
|---|---|---|
| `(super-admin)` | dashboard, borrowers, settings, reports, … | Pass |
| `(collector)` | collector/dashboard, settings, … | Pass |
| `(registration-officer)` | officer/register, settings, … | Pass |
| `(approver)` | approver/pending, settings, … | Pass |
...
- Largest route bundles: borrowers/groups (~557–561 kB) — expected for data-heavy panels
