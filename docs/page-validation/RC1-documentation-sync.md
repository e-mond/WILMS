...
| Document | Action |
|----------|--------|
| [PROJECT_STATUS.md](../../PROJECT_STATUS.md) | Updated — RC1 status, hotfix PR #35, verification counts |
| [README.md](../../README.md) | Updated — migration count, CI Node 22, production URLs |
| `docs/page-validation/RC1-*.md` | Created/updated — full audit set (14 reports) |
