...
| File | Change | Reason |
|---|---|---|
| `SuperAdminDashboard.tsx` | Removed unused type import `DashboardQuickActionIconName` | ESLint `@typescript-eslint/no-unused-vars` — build gate |
...
- `ManagementToolbar.tsx` (shared list/report toolbar — **not** a dashboard component)
