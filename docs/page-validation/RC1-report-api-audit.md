...
`apps/backend/src/tests/reports/domain.test.ts` — 4 tests covering filter/summarize, collector mapping, group risk, ledger date filter.
...
|----------|------------|---------|
| loan-portfolio | No loans in DB | Data-driven empty — OK |
| defaulters | No `DEFAULTED` loans | Data-driven empty — OK |
| collector-performance | No collectors | Data-driven empty — OK |
| group-risk | No groups | Data-driven empty — OK |
| financial-ledger | No payments in date range | Data-driven empty — OK |
