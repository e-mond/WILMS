# RC1.3.2 — Documentation Synchronization
...
**Result: PARTIAL** — `main` docs reflect RC1.2; RC1.3 and RC1.3.2 evidence added this run. Stale production claims corrected below.
...
| Path | On `main`? |
|------|------------|
| `docs/page-validation/RC1.3-*.md` | **NO** — on `release/rc1-3-final-certification` only |
