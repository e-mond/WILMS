...
| Check | Result |
|-------|--------|
| Migration files `0000`–`0010` | 11 sequential files — PASS |
...
Production list APIs return HTTP 500 — suggests schema/data edge case post-rebuild. Requires Railway logs + SQL verification before sign-off.

## Pass gate

**PARTIAL** — migrations OK; data cleanliness and API stability on empty DB pending
