...
| Script | Present |
|--------|---------|
| `verify:api-integrity` | Ô£ô |
| `verify:api-coverage` | Ô£ô |
| `verify:mock-guard` | Ô£ô |
| `smoke:production` | Ô£ô |
| `smoke:rbac` | Ô£ô |
| `bundle:budget-check` | Ô£ô |
| `perf:budget-check` | Ô£ô |
| `test:e2e` | Ô£ô |

## Cross-links

RC1.2 evidence index: `docs/page-validation/RC1.2-final-report.md`  
Baseline: 21├ù `RC1.1-*.md` reports
