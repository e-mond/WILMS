...
320px ┬À 375px ┬À 425px ┬À 768px ┬À 1024px ┬À 1280px+ ┬À ultrawide

## Current Implementation Status

| Widget | Mobile stack | Chart overflow | Text truncation | Status |
|---|---|---|---|---|
| Collector Performance | Grid ÔåÆ 1 col on `sm` | Sparklines in scroll container | Truncate on names | Pass (code review) |
...
| Borrower Status | Grid 2-col ÔåÆ 1-col | OK | OK | Pass |

## Known Gaps

- JPEG validation not yet captured at all breakpoints
- Ultrawide (>1920px) max-width constraint relies on shell content area ÔÇö verify on 2560px monitor
